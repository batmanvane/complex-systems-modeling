  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.4\textwidth}
      \begin{figure}
        ...
        \caption{\scriptsize Source: S.H. Strogatz, \emph{Nonlinear Dynamics and Chaos}, 2nd ed., Westview Press, 2018}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.2\textwidth]{phase_portraits_nodes.png}
    \caption{\tiny
      \(\begin{array}{lllll}
      \text{(a)}\, a<-1 &\text{Stable node, tangent to }y\text{-axis} &
      \text{(b)}\, a=-1 &\text{Star node} \\
      \text{(c)}\, -1<a<0 &\text{Stable node, tangent to }x\text{-axis} &
      \text{(d)}\, a=0 &\text{Line of fixed points} &
      \text{(e)}\, a>0 &\text{Saddle}
      \end{array}\)
    Source: S.H. Strogatz, \emph{Nonlinear Dynamics and Chaos}, 2nd ed., Westview Press, 2018}
...
\begin{frame}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.42\textwidth}
      ...
      {\scriptsize Source: adapted from S.H. Strogatz, \emph{Nonlinear Dynamics and Chaos}, 2nd ed., Westview Press, 2018, Fig.\,5.1.6}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  {\scriptsize Decomposition of an initial condition into eigenvector components. Source: S.H. Strogatz, \emph{Nonlinear Dynamics and Chaos}, 2nd ed., Westview Press, 2018}
\end{frame}
